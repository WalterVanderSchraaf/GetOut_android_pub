...
import static com.endeavor.walter.getout9.MathUtil.EARTH_RADIUS;
import static com.endeavor.walter.getout9.MathUtil.clamp;
import static com.endeavor.walter.getout9.MathUtil.hav;
import static com.endeavor.walter.getout9.MathUtil.havDistance;
import static com.endeavor.walter.getout9.MathUtil.havFromSin;
import static com.endeavor.walter.getout9.MathUtil.inverseMercator;
import static com.endeavor.walter.getout9.MathUtil.mercator;
import static com.endeavor.walter.getout9.MathUtil.sinFromHav;
import static com.endeavor.walter.getout9.MathUtil.sinSumFromHav;
import static com.endeavor.walter.getout9.MathUtil.wrap;
import static com.endeavor.walter.getout9.SphericalUtil.computeDistanceBetween;
...
if(idx > 0){
    Log.i("isLocationOnEdgeOrPath", " WVS index = " + idx + ", " + poly.get(idx).toString() + " next latlng " + poly.get(idx +1).toString());
//    Log.i("isLocationOnEdgeOrPath", " WVS index = " + idx + ", " + poly.get(idx) ;
}
//        return (idx >= 0); if equal to zero it's a best guess so omit this one
        return (idx > 0);   // WVS only return TRUE if it's accurate not guess
    }
